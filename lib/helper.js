...
var evaluateAction = function (msg, callback) {
   ...
   case 'PUT':
      ...
      break;
   case 'GET':
      return getAction     (msg, callback)
      break;
   case 'FETCH':
      return fetchAction   (msg, callback)
      break;
   case 'CREATE':
      return createDBAction(msg, callback)
      break;
   case 'DELETE':
      return deleteDBAction(msg, callback)
      break;
   default:
      return {
