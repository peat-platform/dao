...
var putAction = function (msg, callback) {
   ...
   db.get(msg.database, function (err, db_body) {
      ...
      console.log("------------")
      console.log(db_body.value.openi_type)
      console.log(db_body.value.data)
      console.log("------------")
      console.log(msg.object_data.openi_type)
      console.log(msg.object_data.data)
      console.log("------------")
