...
var evaluateAction = function (msg, callback) {
   ...
   dbc.hasMemberIn(msg, 'action', ['POST', 'PUT', 'GET', 'FETCH', 'CREATE', 'DELETE', 'VIEW', 'GET_OR_POST', 'PATCH_ATTACHMENT', 'PATCH_ATTACHMENT_OBJECT', 'UPDATE_PERMISSIONS', 'APP_PERMISSIONS', 'GENERIC_CREATE', 'GENERIC_READ', 'GENERIC_UPDATE', 'GENERIC_DELETE', 'GENERIC_PATCH', 'GENERIC_UPSERT', 'GENERIC_QUERY']);
