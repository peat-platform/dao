...
var init = function (logger_params) {
   ...
   dbs['openi'] = new couchbase.Connection({host: 'localhost:8091', bucket: 'openi', connectionTimeout:5000}, function (err) {
      if (err) {
   ...
   dbs['attachments'] = new couchbase.Connection({host: 'localhost:8091', bucket: 'attachments', connectionTimeout:5000}, function (err) {
      if (err) {
         console.log('Connection Error', err);
      }
      else {
