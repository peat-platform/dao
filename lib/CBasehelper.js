...
var evaluateAction = function (msg, callback) {
   ...
   dbc.hasMemberIn(msg, 'action', ['POST', 'PUT', 'GET', 'FETCH', 'CREATE', 'DELETE', 'VIEW', 'GET_OR_POST', 'PATCH_ATTACHMENT', 'PATCH_ATTACHMENT_OBJECT', 'UPDATE_PERMISSIONS', 'GENERIC_CREATE', 'GENERIC_READ', 'GENERIC_UPDATE', 'GENERIC_DELETE', 'GENERIC_PATCH', 'GENERIC_UPSERT']);
   ...
   dbc.conditionalHasMember(msg, 'data', (msg.action === 'GENERIC_CREATE' || msg.action === 'GENERIC_UPDATE' || msg.action === 'GENERIC_PATCH' || msg.action === 'GENERIC_UPSERT'));
