...
var handleTypeParameters = function(db, msg, mongPush) {
	var response
	var query = msg.query
	var params = {}
...
var getAction = function(msg, mongPush){
	...
	case 4:
		if (msg.name[2] === 'type')
		{
			...
			{
				handleTypeParameters(db,msg,mongPush)
			}
			else
			{
				db.get(msg.name[1], { revs_info: false }, function(err, db_body){
